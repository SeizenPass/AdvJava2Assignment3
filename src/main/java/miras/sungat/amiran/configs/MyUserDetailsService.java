...
import miras.sungat.amiran.dao.UserDAO;
import miras.sungat.amiran.model.Authority;
...
public class MyUserDetailsService implements UserDetailsService
{
    ...
    public UserDetails loadUserByUsername(final String username) throws UsernameNotFoundException
    {
        ...
        miras.sungat.amiran.model.User user = userDAO.findByUserName(username);
    ...
    private User buildUserForAuthentication(miras.sungat.amiran.model.User user, List<GrantedAuthority> authorities)
    {
